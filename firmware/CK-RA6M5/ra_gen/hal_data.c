...
/* Actual period: 3 seconds. Actual duty: 50%. */.period_counts = (uint32_t) 0x11e1a300,
  .duty_cycle_counts = 0x8f0d180, .source_div = (timer_source_div_t) 0, .channel = 0, .p_callback = timer3s_callback,
